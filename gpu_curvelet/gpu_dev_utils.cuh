#ifndef GPU_DEV_UTILS_CUH
#define GPU_DEV_UTILS_CUH
...
To2Pi (float angle)
{
  ...
  //> These two lines of code is to fix the bug when
  //  angle = -1.1721201390607859e-016
  //  then after all the computation, we get
  //  a = 6.2831853071795862 == 2*pi !!!!!!!
...
// __device__ __forceinline__ float to_2pi(float angle)
// {
//     constexpr float two_pi = 6.283185307179586f;
//     float a;
//     if (angle >= two_pi) {
//         a = fmodf(angle, two_pi);
//     } else if (angle < 0.f) {
//         a = two_pi + fmodf(angle, two_pi);
//     } else {
//         a = angle;
//     }
//     if (!(a >= 0.f && a < two_pi)) {
